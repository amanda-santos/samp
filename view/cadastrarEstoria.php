...
<div class="row">
  	...
  	<div class = "post">
      <form class="form-horizontal" method="POST" action="../controller/cadastrarEstoria.php?id=<?php echo utf8_decode (strip_tags(trim($_GET['id']))) ?>" enctype="multipart/form-data" data-toggle="validator">
