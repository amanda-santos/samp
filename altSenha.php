...
if (isset($_SESSION["usuario"])) { //SE EXISTIR AUTENTICAÇÃO
  ...
  if ($result->num_rows > 0) { // Exibindo cada linha retornada com a consulta
    while ($exibir = $result->fetch_assoc()){
      $antigaCodificada = $exibir["senha"]; //a variável $antiga recebe a senha do banco, sendo a senha ANTIGA do usuário
      $antiga = base64_decode($antigaCodificada);
    } // fim while
  ...
  if (isset($_POST["alterar"])) {
    ...
    //senhas atual e nova passadas pelo formulário
    $atual = $_POST["atual"];
    $nova = $_POST["nova"];
  
    if ($antiga == $atual) { //se a senha antiga (BD) e atual (passada pelo usuário no formulário) forem iguais, a alteração da senha pela nova é permitida
      $novaCodificada = base64_encode($nova);
      $sql = "UPDATE tb_usuario SET senha= '".$novaCodificada."' WHERE usuario='$usuario'";;
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SAMP</div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="img/profile.png" width="60px">
              </a>
          ...
          <div class="row">
            <div class="col-md-8"> 
              ...
              <div class = "post">
                <h1>Editar conta</h1>
                <hr>
                <form class="form-horizontal" method="POST" action="altSenha.php" enctype="multipart/form-data" data-toggle="validator">

                <div class="form-group">
                  <label class="control-label col-sm-3" for="atual">Digite sua senha atual:</label>
                  <div class="col-sm-5">
                    <input type="password" class="form-control" id="atual" name="atual" data-minlength="6" required>
                  </div> <!--fim col-sm-5-->
                </div> <!--fim form-group-->
                
                <div class="form-group">
                  <label class="control-label col-sm-3" for="nova">Digite sua nova senha:</label>
                  <div class="col-sm-5">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-3" for="confSenha">Confirme sua senha:</label>
                  <div class="col-sm-5">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SAMP: SCRUM - Agile - Management - Development - 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
