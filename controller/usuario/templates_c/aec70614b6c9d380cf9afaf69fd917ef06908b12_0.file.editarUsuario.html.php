<?php
/* Smarty version 3.1.33, created on 2019-06-15 01:29:57
  from 'C:\xampp\htdocs\samp\view\usuario\editarUsuario.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d042df5060ff6_48978405',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'aec70614b6c9d380cf9afaf69fd917ef06908b12' => 
    array (
      0 => 'C:\\xampp\\htdocs\\samp\\view\\usuario\\editarUsuario.html',
      1 => 1560554890,
      2 => 'file',
    ),
  ),
...
function content_5d042df5060ff6_48978405 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="row">
  <div class="col-md-8"> 
    ...
    <!-- início do post -->
    <div class = "post">
      <form class="form-horizontal" method="POST" action="../../controller/usuario/editarUsuario.php" enctype="multipart/form-data" data-toggle="validator">
...
">
      ...
      <div class="col-sm-9">
        <p>
          <a href="../../controller/usuario/alterarSenha.php"  id="admButtons" class="btn btn-sm btn-success" style="font-size: 14px;">
 ...
 type="text/javascript">
        function apagar(usuario) {
          if (window.confirm('Deseja realmente desativar sua conta @' + usuario + '? Essa ação não poderá ser desfeita.')) {
            window.location = '../../controller/usuario/inativarUsuario.php?usuario=' + usuario;
          }
        }
