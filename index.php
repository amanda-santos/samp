...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">SAMP</a>
  ...
  <section class="portfolio bg-primary text-white" id="about">
    <div class="container">

      <h2 class="text-center text-uppercase">Sobre</h2>
      <hr class="star-light mb-5">
          <p class="text-center lead" text-align="center">SAMP (Scrum - Agile - Management - Planning) é uma ferramenta com o objetivo de auxiliar o gerenciamento de Sprints e tarefas em processos de desenvolvimento de software baseados na metodologia Scrum.</p>
    </div>
  </section>
  ...
  <section class="bg-primary text-white" id="account">
    <div class="container">
  ...
  <div class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; SAMP: SCRUM - Agile - Management - Development - 2019</small>
    </div>
  </div>
