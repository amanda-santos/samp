        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="post" action="inserirConta.php" enctype="multipart/form-data" data-toggle="validator">
                ...
                <p>
                  <input type="submit" class="btn btn-primary btn-user btn-block" value="Criar conta" name = "cadastrar"></input>
                </p>
              </form>
              <hr>
              <div class="text-center">
